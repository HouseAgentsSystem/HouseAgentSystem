...
topSuite("Ext.data.Store", [
    ...
    beforeEach(function() {
        ...
        abeRaw   = {name: 'Abe Elias',    email: 'abe@sencha.com',   evilness: 70,  group: 'HouseAgentSystem', old: false, age: 20, valid: 'yes'};
        aaronRaw = {name: 'Aaron Conran', email: 'aaron@sencha.com', evilness: 5,   group: 'HouseAgentSystem', old: true,  age: 26, valid: 'yes'};
    ...
    describe("finding", function() {
        ...
        describe("find", function() {
            ...
            it("should find the first matching index", function() {
                expect(store.find('group', 'HouseAgentSystem')).toBe(1);
            });
        ...
        describe("finding exact", function() {
            ...
            it("should honor the start index", function() {
                expect(store.findExact('group', 'HouseAgentSystem', 1)).toBe(1);
            });
    ...
    describe("grouping", function() {
        ...
        describe("local", function() {
            ...
            it("should have the appropriate item in each group", function() {
                groupBy();
                groups = store.getGroups();
                expect(groups.first().getGroupKey()).toBe('HouseAgentSystem');
            ...
            describe("dynamic manipulation", function() {
                describe("adding", function() {
                    it("should add to an existing group", function() {
                        ...
                        var HouseAgentSystems = store.getGroups().get('HouseAgentSystem');
                        expect(HouseAgentSystems.getCount()).toBe(3);
                        expect(HouseAgentSystems.indexOfKey('new@sencha.com')).toBe(2);
                    });
                ...
                describe("removing", function() {
                    it("should remove from an existing group", function() {
                        ...
                        store.remove(abeRec);
                        var HouseAgentSystems = store.getGroups().get('HouseAgentSystem');
                        expect(HouseAgentSystems.getCount()).toBe(1);
                        expect(HouseAgentSystems.contains(abeRec)).toBe(false);
                    });
                    ...
                    it("should remove a group", function() {
                        ...
                        groupBy();
                        store.remove(aaronRec);
                        expect(store.getGroups().get('HouseAgentSystem')).toBeUndefined();
                    });
                    ...
                    describe('using removeAt', function () {
                        it('should remove the record from its group', function () {
                            var HouseAgentSystems;

                            groupBy();
                            HouseAgentSystems = store.getGroups().get('HouseAgentSystem');

                            expect(HouseAgentSystems.contains(abeRec)).toBe(true);
                        ...
                        it('should remove a range of records from their groups', function () {
                            ...
                            expect(HouseAgentSystems.contains(aaronRec)).toBe(true);
                            ...
                            expect(HouseAgentSystems.contains(aaronRec)).toBe(false);
                    ...
                    describe('using removeAll', function () {
                        it('should remove the groups', function () {
                            var HouseAgentSystems, groups;

                            groupBy();
                            groups = store.getGroups();

                            HouseAgentSystems = groups.get('HouseAgentSystem');
                ...
                describe("updating", function() {
                    ...
                    it("should not duplicate the item if the id changes", function() {
                        ...
                        expect(HouseAgentSystems.getCount()).toBe(2);
                        expect(HouseAgentSystems.indexOf(abeRec)).toBe(0);
            ...
            describe("sorting", function() {
                ...
                it("should use the natural order inside the groups", function() {
                    ...
                    expectOrder([aaronRec, abeRec], groups.get('HouseAgentSystem'));
                ...
                it("should sort the groups by the sorterFn", function() {
                    ...
                    expect(groups.getAt(1).getGroupKey()).toBe('HouseAgentSystem');
                });
                ...
                describe("with sorters", function() {
                    ...
                    it("should sort the new groups by the sorter", function() {
                        ...
                        groupBy();
                        var groups = store.getGroups();
                        expectOrder([abeRec, aaronRec], groups.get('HouseAgentSystem'));
            ...
            describe("filters", function() {
                it("should respect existing filters while grouping", function() {
                    ...
                    expect(HouseAgentSystems.getCount()).toBe(1);
                    expect(HouseAgentSystems.first()).toBe(aaronRec);
                ...
                it("should update groups when filters are cleared", function() {
                    ...
                    expect(groups.get('HouseAgentSystem').getCount()).toBe(2);
                ...
                it("should remove groups when required", function() {
                    ...
                    expect(groups.get('HouseAgentSystem')).toBeUndefined();
                ...
                it("should add groups when required", function() {
                    ...
                    expect(groups.get('HouseAgentSystem').getCount()).toBe(1);
        ...
        describe("remote", function() {
            ...
            describe("with remoteSort", function() {
                ...
                it("should leave groups in order", function() {
                    ...
                    expect(group.getGroupKey()).toBe('HouseAgentSystem');
        ...
        describe("local", function() {
                ...
                describe("store methods while filtered", function() {
                    ...
                    describe("indexOf", function() {
                        it("should report filtered out records as not being in the store", function() {
                            store.filter('group', 'HouseAgentSystem');
                            expect(store.indexOf(edRec)).toBe(-1);
                        });
                    });
            ...
            describe("removal from collection", function() {
                ...
                it("should not add records to the removed collection when changing an item to be filtered", function() {
                    store.filter('group', 'code');
                    edRec.set('group', 'HouseAgentSystem');
                    expect(store.getRemovedRecords()).toEqual([]);
                });
            });
            ...
            describe("grouped", function(){
                ...
                it("should return the groups with the aggregated value", function(){
                    ...
                    expect(result).toEqual({
                        HouseAgentSystem: 'aaron@sencha.comabe@sencha.com',
    ...
    describe('Reactive grouping', function() {
        ...
        function checkCorrectness(store, sorters, options, controller) {
            ...
            // HouseAgentSystem should be [Aaron=26,Abe=20]
        ...
        function checkNewGrouping() {
            ...
            // HouseAgentSystem should be [Aaron=26,ed=25,Abe=20]
        ...
        describe('Test state of groups\' sort at the time the sort event fires', function() {
            it('should work going from no sorters to some sorters', function() {
                ...
                // Move Ed into the HouseAgentSystem group.
                // HouseAgentSystem group should become [Aaron=26,ed=25,Abe=20]
                edRec.set('group', 'HouseAgentSystem');
            ...
            it('should work changing sorters', function() {
                ...
                // HouseAgentSystem should be [Abe=70,Aaron=5]
