...
<html>
	...
	<body>
				...
				<div class="col-md-7" style="background-color: #f1f1f1;">
					<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
					  ...
					  <div class="carousel-inner" role="listbox" style="height: 400px;">
					    ...
					    <div class="item">
					      <img src="../Customer/images/4.jpg" alt="..." style="height: 400px; width: 100%;">
					    </div>
					    <div class="item">
					      <img src="../Customer/images/2.jpg" alt="..." style="height: 400px; width: 100%;">
					    </div>
					    <div class="item">
					      <img src="../Customer/images/5.jpg" alt="..." style="height: 400px; width: 100%;">
					    </div>
					  </div>
	    ...
	    <script type="text/javascript">
			...
			var mPoint = new BMap.Point(${requestScope.house.latitude},${requestScope.house.longitude});  
